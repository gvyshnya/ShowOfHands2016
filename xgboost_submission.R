# This module contains the script to train the XGBOOST
...
#
# Summary: 
# - submission of prediction results of XGBOOST model with tuned parameters
# - XGBOOST model invoked via caret interface
...
output.csv.file <- "Submission_xgboost.csv"
...
#######################################################
# Modelling and predictions: XGBOOST
#######################################################
...
TestPredictions.full <- xgboost1.test.pred #calibrated prediction
p.test <- p.xgboost1.test #non-calibrated prediction
#  
TrainPredictions.full <- xgboost1.train.pred
...
ROCRpred.calib <- prediction(xgboost1.test.pred, validate.tr$Party)
